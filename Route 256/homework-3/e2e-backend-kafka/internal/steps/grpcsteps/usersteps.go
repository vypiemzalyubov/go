...
func (s *UserSteps) CreateUser(ctx context.Context, t provider.T, user *models.User) (*models.User, error) {
	if user == nil {
		user = &models.User{
...
func (s *UserSteps) LogIn(ctx context.Context, t provider.T, phone string, password string) (*wallet.LogInResponse, error) {
...
func (s *UserSteps) GetUser(ctx context.Context, t provider.T, userID string) (*models.User, error) {
...
func (s *UserSteps) CreateAccount(ctx context.Context, t provider.T, userID string, description string, amount int32) (*models.Account, error) {
...
func (s *UserSteps) GetAccountBalance(ctx context.Context, t provider.T, userID, accountID string) (*models.Balance, error) {
...
func (s *UserSteps) UpgradeUser(ctx context.Context, t provider.T, userID string) error {
...
func (s *UserSteps) Credit(ctx context.Context, t provider.T, userID, accountID string, amount int32) error {
...
func (s *UserSteps) Debit(ctx context.Context, t provider.T, userID, accountID string, amount int32) error {
