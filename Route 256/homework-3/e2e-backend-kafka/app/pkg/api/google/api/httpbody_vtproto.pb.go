...
func (m *HttpBody) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if unmarshal, ok := interface{}(m.Extensions[len(m.Extensions)-1]).(interface {
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.Extensions[len(m.Extensions)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
